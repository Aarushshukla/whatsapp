...
fun AppDrawer(onItemClick: (String) -> Unit) {
    ModalDrawerSheet(drawerContainerColor = Color.White) {
        ...
        Section("STORAGE"); DrawerItem("Media Overview", Icons.Default.PermMedia) { onItemClick("media_overview") }; DrawerItem("Photos", Icons.Default.Photo) { onItemClick("photos") }; DrawerItem("Videos", Icons.Default.VideoFile) { onItemClick("videos") }; DrawerItem("Audio", Icons.Default.GraphicEq) { onItemClick("audio") }; DrawerItem("Documents", Icons.Default.Description) { onItemClick("documents") }; DrawerItem("Statuses", Icons.Default.Schedule) { onItemClick("statuses") }; DrawerItem("Stickers", Icons.Default.EmojiEmotions) { onItemClick("stickers") }
        Section("TOOLS"); DrawerItem("Duplicate Finder", Icons.Default.ContentCopy) { onItemClick("duplicate_finder") }; DrawerItem("Large Files", Icons.Default.Folder) { onItemClick("large_files") }; DrawerItem("Old Media", Icons.Default.History) { onItemClick("old_media") }; DrawerItem("Blurry Images", Icons.Default.BlurOn) { onItemClick("blurry_images") }; DrawerItem("Scan History", Icons.Default.Timeline) { onItemClick("scan_history") }; DrawerItem("Last Cleanup Receipt", Icons.Default.ReceiptLong) { onItemClick("last_cleanup_receipt") }; DrawerItem("Storage Overview", Icons.Default.Storage) { onItemClick("storage_overview") }
